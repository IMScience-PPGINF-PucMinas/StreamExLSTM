...
parser.add_argument("--path", type=str,
                    default='../streamexlstm/Summaries/streamexlstm/exp1/SumMe/results/split0',
...
dataset_path = '../streamexlstm/data/datasets/' + dataset + '/eccv16_dataset_' + dataset.lower() + '_google_pool5.h5'
